...
### Seedance 2.0을 작업 의도에 맞게 사용합니다

대사·연기·제품 상호작용·정밀 카메라가 핵심이면 한 번에 하나의 통제된 숏을
사용합니다. 단순 비트 2~4개는 전체 클립 재생성 위험을 받아들일 수 있을 때
네이티브 타임코드 멀티숏으로 만들 수 있습니다. 프롬프트는 무조건 짧게 하지
않고 핵심 지시를 앞에 둔 최소 충분 길이를 사용하며 단어 수는 경고 기준입니다.
...
좋은 프레임을 고를 수 있습니다. 스키마 v9은 시작 이미지 사전 검수, 첫
