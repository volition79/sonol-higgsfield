...
스키마 v5는 첫 프레임 QC, 경계 분석 기록, 잠긴 스토리 고정점과 이전 영상의
...
화면상 대사는 ElevenLabs V3 마스터를 먼저 확정해 Seedance 음성 참조로
사용하고, 생성 영상의 오디오를 제거한 뒤 원본 마스터를 최종 믹스에 다시
넣습니다. 내레이션, 앰비언스, 폴리, 효과음과 음악은 분리해서 관리합니다.
