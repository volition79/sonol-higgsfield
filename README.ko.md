...
숏과 숏 사이에서 유지합니다. 모든 숏은 고정 ID, 시작 상태, 종료 상태,
레퍼런스와 연결 지점을 가집니다.
...
제한과 예상 비용을 확인합니다. 요구사항, 에셋, 숏과 크레딧 상한선은
명시적인 사용자 승인 단계를 거칩니다. 사용자의 침묵은 승인으로 처리하지
않습니다.
...
대사, 내레이션, 앰비언스, 효과음과 음악을 명시적으로 분기하여 모든 생성
클립의 원본 오디오를 무조건 유지하거나 교체하지 않습니다.
...
5. Higgsfield 라이브 스키마, 크레딧과 비용을 확인합니다.
6. 애니매틱과 레퍼런스를 승인합니다.
...
> 먼저 나를 인터뷰하고, 스토리보드와 비용 견적을 보여준 뒤 내가 승인하기
> 전에는 유료 생성을 실행하지 마.
...
- Higgsfield 유료 작업은 크레딧을 사용합니다. 스킬은 명시적인 승인을
  요구하지만 이미 제출된 제공자 작업을 되돌릴 수는 없습니다.
